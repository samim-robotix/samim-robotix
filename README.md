...
I build and deploy autonomous mobile robots — perception, planning, control, and real hardware integration. My M.Tech thesis develops a **Fuzzy Adaptive Control Barrier Function + Takagi-Sugeno MPC** framework for safe navigation in dynamic environments, implemented on a physical 4-wheeled robot (Raspberry Pi 5 + Hailo AI Hat, 2D LiDAR, IMU, encoder motors).
...
*\*Final thesis evaluation marks not yet reflected by the university.*

---

## Featured Projects

| Project | Hardware | Stack | Role | Status |
|---|---|---|---|---|
| **Autonomous Safety Robot** — Fuzzy Adaptive CBF + TS-MPC safe navigation (M.Tech thesis) | RPi5, Hailo AI Hat, 2D LiDAR, IMU, encoder, USB cam | ROS2, Nav2 | Thesis project | 🔬 Paper in preparation |
| **ISRO I-RoCU 2024 Rover** — 6-wheeled GPS-denied rover with 6-DOF arm | Jetson Orin Nano, 2D LiDAR, depth cam, IMU | ROS2, Nav2, SLAM, Sensor Fusion | Team Lead (10-member team) | ✅ 5th Nationally / 283, physical finals |
| **Low-Light Navigation AMR** — Trains on LiDAR, deploys LiDAR-free using only an IR camera | RPi5, Hailo AI Hat, IR cam | ROS2, Nav2 | Design & implementation | 🔬 Paper in preparation |
| **Gesture-Controlled Robotic Arm** — CNN-based intent recognition driving a 6-DOF arm, no depth camera | ESP32, 6-DOF servo arm, MPU6050 | MediaPipe, YOLOv11, WebSocket | Design & implementation | 🔬 Targeting IEEE venue |
| **Vision-Based Pick-and-Place Arm** — Self-built 3D-printed 6-DOF arm | Jetson Nano, servo motors | YOLOv8, FK/IK, DH parameters | Self-built | ✅ Completed |
| **Mathematical Bot** — 4-wheeled swarm robot, GPS-free trajectory following | 4-wheel chassis, IMU, encoder | ROS2 | Solo — design, build, code | 🚧 In development |

*Repos will be linked here as each project is cleaned and uploaded.*

---

## Other Projects & Research Support

- **Shadow-Based Contour Detection** — measures object geometry from shadows (RPi4). Advanced to Round 3 of 5, T-Works/IISc Bangalore funded competition.
- **Smart Dustbin** — real-time vision-based waste sorting, 3 bin variants (RPi5 + Hailo AI Hat). Pursuing a state government funding proposal.
- **Brain-Controlled Jaco Arm** — assisted a PhD scholar's research (19-channel EEG, 50+ subjects). Role: hardware setup, data collection, EEG classification support.
- **Brain-Controlled Mobile Robot** — 5-channel Emotiv EEG driving 4-class control of a 4-wheeled rover (RPi4).
- **Smart Agriculture Robot** — crop-disease detection + fertilizer spray rover (YOLOv8). Role: Assistant.
- **Autonomous Quadcopter** — assembled and flying in RC mode; autonomous stack (VTOL, hovering, waypoint navigation, SLAM) under active development.
...
**Intelligent Cyber Physical System (ICPS) Lab** — Co-founder, Jadavpur University (ETCE)
...
**Thesis:** *Fuzzy Adaptive CBF for Safe Mobile Robot Navigation via Takagi-Sugeno MPC in Dynamic Environments* — Guide: Prof. Amit Konar (FNAE). Submitted, defended, course completion certificate issued (June 2026).

---

## Timeline

- **2015–2019** — B.Tech, Electrical Engineering (CGPA 7.35)
- **2019–2020** — GATE exam preparation
- **2020–2022** — Self-learning and freelance work (electrical); family support during COVID
- **2022 (Dec) – 2024 (Jan)** — Technical Lab Instructor, Techno Main Salt Lake (EE & CSE departments)
- **2023** — Began M.Tech, Jadavpur University; co-founded ICPS Lab
...
- 25+ robotics workshops conducted since 2019 — 5,000+ students trained
- Collaborations: **IEEE**, **Jadavpur University**, **Macmillan Education**, **Ardent Computech**, **DITO**
- Trained 50+ CBSE-board teachers on AI tools for classroom use (with Macmillan Education)
- Robotics Trainer & Project Guide, DITO — taught Arduino/ESP32 automation, IoT, and sensor integration to rural girl students (Jul 2024 – Jan 2025)
...
[![LinkedIn](https://img.shields.io/badge/LinkedIn-0077B5?style=for-the-badge&logo=linkedin&logoColor=white)](https://www.linkedin.com/in/samimrobotix/)
[![Email](https://img.shields.io/badge/Email-D14836?style=for-the-badge&logo=gmail&logoColor=white)](mailto:samim.robotix@gmail.com)
[![Google Scholar](https://img.shields.io/badge/Google_Scholar-4285F4?style=for-the-badge&logo=google-scholar&logoColor=white)](https://scholar.google.com/citations?hl=en&user=uaq0i-4AAAAJ)
[![GitHub](https://img.shields.io/badge/GitHub-181717?style=for-the-badge&logo=github&logoColor=white)](https://github.com/samim-robotix)

📍 Kolkata, India — Open to relocation within India

<img src="https://komarev.com/ghpvc/?username=samim-robotix&style=flat-square&color=0f3460&label=Profile+Views" alt="profile views"/>
